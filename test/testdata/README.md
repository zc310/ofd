...
| [`hello.ofd`](hello.ofd)                       |  1.4K | 1 页，2 对象，21 字符，1 字体                                              | 最小 Hello World 文档；适合快速验证 OFD 打开、基础文字读取和最小渲染链路。                                                                                                                                                    |
| [`helloworld.ofd`](helloworld.ofd)             |  3.2K | 1 文档，2 页，10 对象，42 字符，1 字体                                     | 基础创建器输出；包含英文和中文文字，适合 converter API、PDF 输出和多页基础渲染测试。生成来源：[`helloworld.yaml`](../../cmd/ofd-creator/examples/helloworld.yaml)。                                                           |
