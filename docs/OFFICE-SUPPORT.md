...
| 类别     | 格式                                                                             | 状态 |
|----------|----------------------------------------------------------------------------------|:----------:|
| 文字文档 | `docx`、`docm`、`dotx`、`dotm`、`doc`、`dot`、`odt`、`ott`、`fodt`、`rtf`、`wps` | ✅ |
| 演示文稿 | `pptx`、`pptm`、`ppsx`、`potx`、`ppt`、`pps`、`pot`、`odp`、`otp`、`fodp`        | ✅ |
| 电子表格 | `xlsx`、`xlsm`、`xltx`、`xltm`、`xls`、`xlt`、`ods`、`ots`、`fods`               | ✅ |
...
| 目标 | 状态 | 说明                                                                    |
|------|:----------:|-------------------------------------------------------------------------|
| PDF  | ✅ | LibreOffice 直接输出，保真度最高；`converter.Convert(from, "pdf", …)`。 |
| OFD  | ✅ | 先转 PDF，再经 `pdf2ofd`；文字可搜索，版式取决于 PDF 转换结果。         |
| 其他 | ✅ | 先导入为 OFD 再走现有导出器（如 Office→html、Office→png）。             |
